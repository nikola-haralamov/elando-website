...
return [
    ...
    */
    ...
    'alpha_dash' => 'Полето :attribute трябва да съдържа само букви, цифри, тирета и долна черта.',
    ...
    'between' => [
        ...
        'string' => 'Полето :attribute трябва да е между :min и :max знаци.',
    ],
    ...
    'gte' => [
        ...
        'string' => 'Полето :attribute трябва да е по-голямо или равно на знаци :value.',
    ],
